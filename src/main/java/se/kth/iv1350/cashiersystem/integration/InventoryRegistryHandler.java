...
public class InventoryRegistryHandler {
    ...
    private void fetchItems() {
        itemCatalog.put("abc123", new ItemDTO("abc123", "BigWheel Oatmeal", 29.90f, "BigWheel Oatmeal 500 g , whole grain oats ," +
                "7 high fiber , gluten free", 6));
        itemCatalog.put("def456", new ItemDTO("def456", "YouGoGo Blueberry", 14.90f, "YouGoGo Blueberry 240 g , low sugar youghurt ," +
                "29 blueberry flavour", 6));
    }
